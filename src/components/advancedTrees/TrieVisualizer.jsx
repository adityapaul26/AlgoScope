    ...
    <div className="flex flex-col h-full w-full">
      <div className="flex flex-col gap-2 p-4 bg-slate-900/50 rounded-xl border border-white/5 mb-4">
        <p className="text-sm text-gray-300">
          Enter a word and click **Insert** to add it to the Trie. Use
          **Delete** to remove a word and **Search** to check its presence. The
        ...
        <div className="flex gap-4">
          ...
          <button
            type="button"
            onClick={() => {
              console.log('Trie Insert clicked')
              handleInsert()
            }}
          ...
          <button
            type="button"
            onClick={() => {
              console.log('Trie Delete clicked')
              handleDelete()
            }}
            className="px-4 py-2 bg-red-600 text-white rounded hover:bg-red-500 transition ml-2"
          >
            Delete
          </button>
          <button
            type="button"
            onClick={() => {
              console.log('Trie Search clicked')
              handleSearch()
            }}
            className="px-4 py-2 bg-emerald-600 text-white rounded hover:bg-emerald-500 transition ml-2"
          >
            Search
          </button>
        </div>
